package devonframe.sample.office.uipattern.mpp1.controller;
...
@Controller("listToEditPatternForMapAndWebPagingController")
public class ListToEditPatternController {
    ...
    @RequestMapping(value="/pattern/mpp1/retrieveEmployeeList.do")
    public String retrieveEmployeeList(@PagingPolicy("policy1")PagingMap pagingMap,  ModelMap model){
        ...
        return "pattern/mpp1/employeeList";
    }

    @RequestMapping(value="/pattern/mpp1/retrieveEmployeeForm.do")
    public String retrieveEmployeeForm(@RequestParam Map<String, Object> input, String mode, ModelMap model){
        ...
        return "pattern/mpp1/employeeForm";
    }

    @RequestMapping(value="/pattern/mpp1/insertEmployee.do")
    public String insertEmployee(@RequestParam Map<String, Object> input, RedirectAttributes redirectAttributes){
        ...
        return "redirect:/pattern/mpp1/retrieveEmployeeList.do";
    }

    @RequestMapping(value="/pattern/mpp1/updateEmployee.do")
    ...
    @RequestMapping(value="/pattern/mpp1/deleteEmployee.do")
