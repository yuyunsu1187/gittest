...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/pattern/mp31/retrieveEmployeeList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/pattern/mp31/retrieveEmployee.do'/>";
   	document.searchForm.submit();
}
function fnInsertForm() {
	document.searchForm.mode.value = "insert";
	document.searchForm.action = "<c:url value='/pattern/mp31/retrieveEmployeeForm.do'/>";
	document.searchForm.submit();
}
//]]>
</script>
	...
	<div id="LblockBodyMain">
        <div id="LblockSearch">
            <div>
                <div>
                    <div>
						<form:form commandName="input" name="searchForm" method="post" onsubmit="fnRetrieveList();return false;">
		...
		<div id="LblockListTable01" class="LblockListTable">
			<div class="Lwrapper">
				<table
					summary="<spring:message code="sample.office.employee.empList"/>">
