...
function fnSave() {
	...
	if(document.detailForm.mode.value == "insert") {
		document.detailForm.action = "<c:url value='/pattern/mpp2/insertEmployee.do'/>";
	}else{
		document.detailForm.action = "<c:url value='/pattern/mpp2/updateEmployee.do'/>";
	}
...
function fnRetrieveList() {
	...
	document.detailForm.action = "<c:url value='/pattern/mpp2/retrieveEmployeeList.do'/>";
	document.detailForm.submit();
}
