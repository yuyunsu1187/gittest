...
function fnRetrieveList() {
	...
	document.searchForm.action = "<c:url value="/pattern/mp2/retrieveEmployeeList.do"/>";
...
function fnSave() {
    ...
    document.listForm.action = "<c:url value="/pattern/mp2/saveEmployeeList.do"/>";
                ...
                <table summary="<spring:message code="sample.office.employee.empList"/>">
                    ...
                    <tbody id="employeeArea">
                        <c:forEach items="${resultList}" var="result" varStatus="status">
                            ...
                            <tr>
                                <td class="Lfirst">
                                    <input type="checkbox" class="Lcheckbox" id="checkData" name="checkData" value="${index}" onclick="fnCheckStateChanged(this)" />
                                ...
                                <td><input type="text" class="Ltext" id="telephone" name="telephone" value="${result.telephone}" size="10" maxlength="11" /></td>
