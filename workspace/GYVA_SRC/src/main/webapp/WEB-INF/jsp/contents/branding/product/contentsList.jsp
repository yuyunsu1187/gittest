...
<script type="text/javascript" language="javascript">
	...
	function goUpdateContents() {
		document.detailForm.action = "<c:url value='/contents/productEdit.do'/>";
		document.detailForm.submit();
	}
	
	// 글 작성 화면으로 이동
	function goContentsWrite() {
		document.listForm.action = "<c:url value='/contents/productWrite.do'/>";
		document.listForm.submit();
	}
	...
	function fnDeleteContents() {
		...
		if (delConfirm) {
			document.detailForm.action = "<c:url value='/contents/productDelete.do'/>";
			document.detailForm.submit();
		}
	}
...
<section id="FR030103-05" class="content-section">
	...
	<c:if test="${menuType=='FR'}">
		<div class="breadcrumb">
			<span class="home">home</span><span class="depth">Branding Platform</span><span class="page">Product Image</span>
		</div>
	</c:if>
	...
	<div class="tab-wrap" data-type="tab" data-tab-division="link">
		...
		<div class="form" data-mult-form="select-list" data-tab-area="tab-list">
			<button type="button" class="select-btn">Product Image<i class="fas fa-angle-down"></i></button>
		...
		<article class="list-wrap" data-list-type="thumbnail" data-combine-list="column-2-list">	
			<form:form commandName="resultList" name="listForm" id="listForm" method="post" >
				...
				<header class="list-header">
					<h3 class="article-tit">Product Image</h3>
					<p class="article-txt">Here you will find product images</p>
					<ul class="sort-list">
