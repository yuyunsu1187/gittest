...
//<![CDATA[
	...
	function fnDeleteContents() {
		...
		if (delConfirm) {
			document.contentsInfo.action = "<c:url value='/contents/clinicDelete.do'/>";
			document.contentsInfo.submit();
		}
	}
...
<section class="content-section">
	...
	<article class="board-wrap" data-board-type="form-write">
		<div class="board-area">
			...
			<form method="post" action="/contents/clinicUpdate.do" name="contentsInfo" id="contentsInfo" onsubmit="return checkValue()" enctype="multipart/form-data">
