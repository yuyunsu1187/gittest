...
//<![CDATA[	
	...
	// 파일 저장
	function fnSave() {
		document.contentsInfo.action = "<c:url value='/contents/partnerInsert.do'/>";
...
<section class="content-section">
	...
	<article class="board-wrap" data-board-type="form-write">
		<div class="board-area">
			...
			<form method="post" action="/contents/partnerInsert.do" name="contentsInfo" id="contentsInfo" onsubmit="return checkValue()" enctype="multipart/form-data">				
