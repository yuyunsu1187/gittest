...
function fnSave() {
    ...
    if (document.inputForm.title.value == "") {
        ...
        document.inputForm.action = "<c:url value='/admin/survey/question/retrieveQuestionWrite.do' />";
    	document.inputForm.submit();
    }	
}
//]]>
...
<section id="AD050901-10" class="content-section">
			...
			<form:form commandName="result" name="inputForm" id="inputForm" method="post">
				<ol class="form-area" data-combine-form="question-form">
					<li>
						...
						<div class="form"><input type="text" class="input-form" name="title" id="title" placeholder="제목을 입력해주세요" /></div>
					</li>
					<li>
						<label for="question1" class="form-tit" data-text-style="essential">1번 문항</label>
						<div class="form"><input type="text" class="input-form" name="question1" id="question1" placeholder="문항을 입력해주세요" /></div>
					</li>
					<li>
						<label for="" class="form-tit" data-text-style="essential">1번 문항형식 선택</label>
						<ul class="form" data-form="radio">
							<li>
								<input type="radio" class="check-form" id="radio01" name="itemCode1" value="SA" checked />
								<label for="radio01" class="label-form">주관식 문항</label>
							</li>
							<li>
								<input type="radio" class="check-form" id="radio02" name="itemCode1" value="MC" />
					...
					<li>
						...
						<div class="form"><input type="text" class="input-form" name="question2" id="question2" placeholder="문항을 입력해주세요" /></div>
					</li>
					<li>
						<label for="" class="form-tit" data-text-style="essential">2번 문항형식 선택</label>
						<ul class="form" data-form="radio">
							<li>
								<input type="radio" class="check-form" id="radio03" name="itemCode2" value="SA" checked />
								<label for="radio03" class="label-form">주관식 문항</label>
							</li>
							<li>
								<input type="radio" class="check-form" id="radio04" name="itemCode2" value="MC" />
					...
					<li>
						...
						<div class="form"><input type="text" class="input-form" name="question3" id="question3" placeholder="문항을 입력해주세요" /></div>
					</li>
					<li>
						<label for="" class="form-tit" data-text-style="essential">3번 문항형식 선택</label>
						<ul class="form" data-form="radio">
							<li>
								<input type="radio" class="check-form" id="radio05" name="itemCode3" value="SA" checked />
								<label for="radio05" class="label-form">주관식 문항</label>
							</li>
							<li>
								<input type="radio" class="check-form" id="radio06" name="itemCode3" value="MC" />
					...
					<li>
						...
						<div class="form"><input type="text" class="input-form" name="question4" id="question4" placeholder="문항을 입력해주세요" /></div>
					</li>
					<li>
						<label for="" class="form-tit" data-text-style="essential">4번 문항형식 선택</label>
						<ul class="form" data-form="radio">
							<li>
								<input type="radio" class="check-form" id="radio07" name="itemCode4" value="SA" checked />
								<label for="radio07" class="label-form">주관식 문항</label>
							</li>
							<li>
								<input type="radio" class="check-form" id="radio08" name="itemCode4" value="MC" />
					...
					<li>
						...
						<div class="form"><input type="text" class="input-form" name="question5" id="question5" placeholder="문항을 입력해주세요" /></div>
					</li>
					<li>
						<label for="" class="form-tit" data-text-style="essential">5번 문항형식 선택</label>
						<ul class="form" data-form="radio">
							<li>
								<input type="radio" class="check-form" id="radio09" name="itemCode5" value="SA" checked />
								<label for="radio09" class="label-form">주관식 문항</label>
							</li>
							<li>
								<input type="radio" class="check-form" id="radio10" name="itemCode5" value="MC" />
				...
				<div class="submit-area">
					...
					<button type="submit" class="main-btn" onclick="fnSave();">등록</button>
				</div>
			</form:form>
		</div>
	</article>
