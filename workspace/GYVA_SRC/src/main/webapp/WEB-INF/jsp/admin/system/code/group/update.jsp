...
<script type="text/javaScript" language="javascript">
	...
	function fnSave() {
	    ...
	    if (document.inputForm.groupName.value == "") {
	        ...
	        document.inputForm.action = "<c:url value='/admin/system/group/retrieveGroupCodeUpdate.do' />";
	    	document.inputForm.submit();
	    }	
	}
	//]]>
				...
				<table class="default-table">
					...
					<tbody>
						<tr>
							...
							<td><div class="form"><input type="text" class="input-form" name="groupName" id="groupName" placeholder="그룹명을 입력해주세요." value="<c:out value='${result.groupName}'/>" /></div></td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="form">
									...
									<input type="text" class="input-form" placeholder="그룹 ID을 입력해주세요." value="<c:out value='${result.groupId}'/>" disabled />
								</div>
							</td>
						</tr>
