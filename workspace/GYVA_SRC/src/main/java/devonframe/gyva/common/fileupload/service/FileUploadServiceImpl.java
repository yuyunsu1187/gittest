package devonframe.gyva.common.fileupload.service;
...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    @Override
	public void updateSlideFileInfo(Map<String, Object> map){
    	   commonDao.update("FileInfo.updateSlideFileInfo", map);
    }
