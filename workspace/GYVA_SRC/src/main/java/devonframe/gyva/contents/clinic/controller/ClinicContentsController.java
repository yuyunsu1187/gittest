package devonframe.gyva.contents.clinic.controller;
...
public class ClinicContentsController {
	...
	static final Logger LOGGER = LoggerFactory.getLogger(ClinicContentsController.class);
    
    @RequestMapping(value="/contents/clinicList.do")
    ...
    @RequestMapping(value="/contents/clinicDetail.do")
	...
	// 관리자 Contents 입력 페이지
	@RequestMapping(value = "/contents/clinicWrite.do")
	public String contentsWrite(Contents input, ModelMap model, HttpSession session){
		...
		return "admin/contents/medical/clinic/contentsWrite";
	}
	
	// 관리자 Contents 수정 페이지 호출
	@RequestMapping(value = "/contents/clinicEdit.do")
	public String contentsUpdate(Contents input, Code code, ModelMap model, HttpSession session) {
		...
		return "admin/contents/medical/clinic/contentsUpdate";
	}
	
	// Contents 저장
	@RequestMapping(value = "/contents/clinicInsert.do")
	...
	// Contents 수정 처리
	@RequestMapping(value = "/contents/clinicUpdate.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/contents/clinicDelete.do")
