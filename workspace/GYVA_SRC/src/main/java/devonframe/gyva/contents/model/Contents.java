package devonframe.gyva.contents.model;

import devonframe.scrollpaging.model.ScrollPagingEntity;

public class Contents extends ScrollPagingEntity{
	...
	private String lecturerImgPath;
	...
	private String previousContentsId;
	private String nextContentsId;
	...
	public String getSldFilePath() {
		return sldFilePath;
	}
	public void setSldFilePath(String sldFilePath) {
	...
	public String getBookmarkMenuId() {
		return bookmarkMenuId;
	}
	public void setBookmarkMenuId(String bookmarkMenuId) {
		this.bookmarkMenuId = bookmarkMenuId;
	}
	...
	public String getPreviousContentsId() {
		return previousContentsId;
	}
	public void setPreviousContentsId(String previousContentsId) {
		this.previousContentsId = previousContentsId;
	}
	public String getNextContentsId() {
		return nextContentsId;
	}
	public void setNextContentsId(String nextContentsId) {
		this.nextContentsId = nextContentsId;
	}
