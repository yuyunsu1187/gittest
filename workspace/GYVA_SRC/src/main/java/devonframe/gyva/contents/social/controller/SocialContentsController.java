package devonframe.gyva.contents.social.controller;
...
public class SocialContentsController {
	...
	static final Logger LOGGER = LoggerFactory.getLogger(SocialContentsController.class);
    
    @RequestMapping(value="/contents/socialList.do")
	...
	// 관리자 Contents 입력 페이지
	@RequestMapping(value = "/contents/socialWrite.do")
	...
	@RequestMapping(value = "/contents/socialEdit.do")
	...
	// Contents 저장
	@RequestMapping(value = "/contents/socialInsert.do")
	...
	// Contents 수정 처리
	@RequestMapping(value = "/contents/socialUpdate.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/contents/socialDelete.do")
