...
public class InjectionContentsController {
	...
	static final Logger LOGGER = LoggerFactory.getLogger(InjectionContentsController.class);
    ...
    public String insertQuestion(Helpdesk input, ModelMap model, HttpSession session){
		...
		String deviceType = (String) session.getAttribute("deviceType");
		String returnUrl = "contents/academy/injection/contentsDetail";
	...
	public String insertSurveyResult(Survey input, ModelMap model, HttpSession session){
		...
		String deviceType = (String) session.getAttribute("deviceType");
		String returnUrl = "redirect:/contents/injectionList.do";
		...
		if (deviceType != null && deviceType.equals("mobile")) {
			...
			returnUrl = "redirect:/mobile/contents/injectionList.do";
