package devonframe.gyva.contents.webinar.controller;
...
public class WebinarContentsController {
	...
	static final Logger LOGGER = LoggerFactory.getLogger(WebinarContentsController.class);
    
    @RequestMapping(value="/contents/webinarList.do")
    ...
    @RequestMapping(value="/contents/webinarDetail.do")
    ...
    @RequestMapping(value="/contents/webinar/insertQuestionInfo.do")
    public String insertQuestion(Helpdesk input, ModelMap model, HttpSession session){

		String deviceType = (String) session.getAttribute("deviceType");
		String returnUrl = "contents/academy/webinar/contentsDetail";
	...
	@RequestMapping(value="/contents/webinar/updateQuestionInfo.do")
	...
	@RequestMapping(value="/contents/webinar/insertSurveyResult.do")
	public String insertSurveyResult(Survey input, ModelMap model, HttpSession session){

		String deviceType = (String) session.getAttribute("deviceType");
		String returnUrl = "redirect:/contents/webinarList.do";
		...
		if (deviceType != null && deviceType.equals("mobile")) {
			...
			returnUrl = "redirect:/mobile/contents/webinarList.do";
	...
	// 관리자 Contents 입력 페이지
	@RequestMapping(value = "/contents/webinarWrite.do")
	public String contentsAcademyWrite(Contents input, ModelMap model, HttpSession session) {
		...
		String nextContentsId =  contentsService.retrieveFunNextContentsId("webinar_id");
		
		model.addAttribute("lecturerList", lecturerList);
		model.addAttribute("surveyList", surveyList);
		model.addAttribute("nextContentsId", nextContentsId);
		
		return "admin/contents/academy/webinar/contentsWrite";
	}

	// 관리자 Contents 수정 페이지
	@RequestMapping(value = "/contents/webinarEdit.do")
	public String contentsUpdate(Contents input, ModelMap model, HttpSession session) {
		...
		return "admin/contents/academy/webinar/contentsUpdate";
	}
	
	// Contents 저장
	@RequestMapping(value = "/contents/webinarInsert.do")
	...
	// Contents 수정 처리
	@RequestMapping(value = "/contents/webinarUpdate.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/contents/webinarDelete.do")
