package devonframe.gyva.contents.product.controller;
...
public class ProductContentsController {
	...
	static final Logger LOGGER = LoggerFactory.getLogger(ProductContentsController.class);
    
    @RequestMapping(value="/contents/productList.do")
	...
	// 관리자 Contents 입력 페이지
	@RequestMapping(value = "/contents/productWrite.do")
	...
	@RequestMapping(value = "/contents/productEdit.do")
	...
	// Contents 저장
	@RequestMapping(value = "/contents/productInsert.do")
	...
	// Contents 수정 처리
	@RequestMapping(value = "/contents/productUpdate.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/contents/productDelete.do")
