...
<section id="FR030109-05" class="content-section">
	...
	<c:if test="${menuType=='FR'}">
		<div class="breadcrumb">
			<span class="home">home</span><span class="depth">Branding Platform</span><span class="page">Social Media</span>
		</div>
	</c:if>
	...
	<div class="tab-wrap" data-type="tab" data-tab-division="link">
		...
		<div class="form" data-mult-form="select-list" data-tab-area="tab-list">
			<button type="button" class="select-btn">Social Media<i class="fas fa-angle-down"></i></button>
		...
		<article class="list-wrap" data-list-type="thumbnail" data-combine-list="column-2-list">
			<form:form commandName="resultList" name="listForm" id="listForm" method="post" >
				...
				<header class="list-header">
					...
					<p class="article-txt">Here you will find social media contents</p>
					<ul class="sort-list">
