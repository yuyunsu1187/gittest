...
public class HelpdeskServiceImpl implements HelpdeskService {
    ...
    public List<Helpdesk> retrieveHelpdeskContentsList(Helpdesk helpdesk) {
        List<Helpdesk> resultList = commonDao.selectList("Helpdesk.retrieveHelpdeskContentsList", helpdesk);
        return resultList;
    } 

    public List<Helpdesk> retrieveHelpdeskContentsPagedList(PagingHelpdesk helpdesk) {
        List<Helpdesk> resultList = commonDao.selectPagedList("Helpdesk.retrieveHelpdeskContentsList", helpdesk);
        return resultList;
    } 

	public void insertQuestionInfo(Helpdesk helpdesk) {
		commonDao.insert("Helpdesk.insertQuestionInfo", helpdesk);
	} 

	public void updateQuestionInfo(Helpdesk helpdesk) {
		commonDao.update("Helpdesk.updateQuestionInfo", helpdesk);
	}
