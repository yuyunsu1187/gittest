package devonframe.gyva.contents.journal.controller;
...
public class JournalContentsController {
	...
	static final Logger LOGGER = LoggerFactory.getLogger(JournalContentsController.class);
    
    @RequestMapping(value="/contents/journalList.do")
    ...
    @RequestMapping(value="/contents/journalDetail.do")
	...
	// 관리자 Contents 입력 페이지
	@RequestMapping(value = "/contents/journalWrite.do")
	public String contentsWrite(Contents input, ModelMap model, HttpSession session) {
		...
		return "admin/contents/medical/journal/contentsWrite";
	}
	
	// 관리자 Contents 수정 페이지 호출
	@RequestMapping(value = "/contents/journalEdit.do") 
	public String contentsUpdate(Contents input, Code code, ModelMap model, HttpSession session) {
		...
		return "admin/contents/medical/journal/contentsUpdate";
	}
	
	// Contents 저장
	@RequestMapping(value = "/contents/journalInsert.do")
	...
	// Contents 수정 처리
	@RequestMapping(value = "/contents/journalUpdate.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/contents/journalDelete.do")
