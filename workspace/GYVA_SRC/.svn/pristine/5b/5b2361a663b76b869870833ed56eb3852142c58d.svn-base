...
<script type="text/javaScript" language="javascript">
	...
	function fnSave() {
	    ...
	    if (document.inputForm.codeName.value == "") {
	        ...
	        document.inputForm.action = "<c:url value='/admin/system/detail/retrieveDetailCodeWrite.do' />";
	    	document.inputForm.submit();
	    }	
	}
	//]]>
				...
				<table class="default-table">
					...
					<tbody>
						<tr>
							...
							<td><div class="form"><input type="text" class="input-form" name="codeName" id="codeName" placeholder="코드명을 입력해주세요." /></div></td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="form" data-form="select">
									<select class="select-form" name="groupId" id="groupId">
										<option value="" selected="selected">그룹 ID</option>
										<c:forEach items="${groupCodeList}" var="groupCode" >
											<option value="${groupCode.code}"><c:out value="${groupCode.value}"/></option>									
										</c:forEach>
									</select>
						...
						<tr>
							...
							<td><div class="form"><input type="text" class="input-form" name="code" id="code" placeholder="코드 ID을 입력해주세요." /></div></td>
						</tr>
