...
<script type="text/javaScript" language="javascript">
	...
	function fnQuestionSave() {
		document.listForm.action = "<c:url value='/contents/webinar/insertQuestionInfo.do'/>";
		document.listForm.submit();
	}
	...
	function fnAnswerSave(seq, type) {
		...
		document.listForm.action = "<c:url value='/contents/webinar/updateQuestionInfo.do'/>";
		document.listForm.submit();	
	}
	...
	function fnSurveySave() {
		if(document.surveyForm.answer1.value == '') {
			...
			document.surveyForm.action = "<c:url value='/contents/webinar/insertSurveyResult.do'/>";
	...
	function goUpdateContents() {
		document.listForm.action = "<c:url value='/contents/webinarEdit.do'/>";
		document.listForm.submit();
	}
	...
	function fnDeleteContents() {
		...
		if (delConfirm) {
			document.listForm.action = "<c:url value='/contents/webinarDelete.do'/>";
			document.listForm.submit();
		}
	}
...
<section id="FR070501-10" class="content-section">
...
<div class="layerPop-wrap" id="FR070501-15" data-pop-action="disabled">
...
<div class="layerPop-wrap" id="FR070501-20" data-pop-action="disabled">
