...
public class AdminSurveyController {
    ...
    /* 문항 등록 */
    @RequestMapping(value="/admin/contents/questionList.do")
    ...
    @RequestMapping(value="/admin/contents/questionForm.do") 
    ...
    public String retrieveQuestionWrite(Survey input, ModelMap model, HttpSession session) throws BusinessException{
        ...
        return "redirect:/admin/contents/questionList.do";
    }

    @RequestMapping(value="/admin/contents/questionDetail.do")
    ...
    /* 결과 조회 */
    @RequestMapping(value="/admin/contents/resultList.do")
    ...
    @RequestMapping(value="/admin/contents/resultDetail.do")
