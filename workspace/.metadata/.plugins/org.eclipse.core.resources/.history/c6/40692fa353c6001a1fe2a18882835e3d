...
function fnRetrieve() {
	...
	document.detailForm.action = "<c:url value='/pattern/mp12/retrieveEmployee.do'/>";
	document.detailForm.submit();
}
function fnDelete() {
	var answer = confirm("<spring:message code="dev.cfm.com.delete"/>");
	if (answer) {
		document.detailForm.action = "<c:url value='/pattern/mp12/deleteEmployee.do'/>";
		document.detailForm.submit();
	}
}
function fnSave() {
	if (!fnValidateRequired(document.detailForm.num, "<spring:message code="dev.warn.com.required3"/>")) return false;
		...
		var url = "<c:url value='/pattern/mp12/insertEmployee.do'/>";
    	if (document.detailForm.updateNum.value.length > 0) {
    		url = "<c:url value='/pattern/mp12/updateEmployee.do'/>";
        }
...
function fnInsert() {
	...
	document.detailForm.action = "<c:url value='/pattern/mp12/insertEmployee.do'/>";
	document.detailForm.submit();
}
function fnReset() {
	document.detailForm.searchNum.value = '';
	document.detailForm.action = "<c:url value='/pattern/mp12/employeeForm.do'/>";
	document.detailForm.submit();
}
...
<div id="LblockBody">
	...
	<div id="LblockBodyMain">
		<form name="detailForm" id="detailForm" method="post" onsubmit="fnRetrieve();return false;">
