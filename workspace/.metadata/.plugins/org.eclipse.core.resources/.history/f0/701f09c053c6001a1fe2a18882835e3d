...
<form:form commandName="employee" name="detailForm" method="post" onsubmit="fnRetrieveList()">
			...
			<tr>
				...
				<td>
						...
						<form:select path="departmentCode" id="departmentCode">
							<form:option value=""><spring:message code="common.label.defaultOption"/></form:option>
							<form:options items="${departmenCodetList}" itemValue="code" itemLabel="value" />
						</form:select><br/>
