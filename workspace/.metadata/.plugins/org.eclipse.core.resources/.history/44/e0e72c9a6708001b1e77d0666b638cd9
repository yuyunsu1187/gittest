...
<script type="text/javaScript" language="javascript">
	...
	function fnQuestionSave() {
		document.listForm.action = "<c:url value='/contents/exercise/insertQuestionInfo.do'/>";
		document.listForm.submit();
	}
	...
	function fnAnswerSave(seq, type) {
		...
		document.listForm.action = "<c:url value='/contents/exercise/updateQuestionInfo.do'/>";
		document.listForm.submit();	
	}
	...
	function fnSurveySave() {
		if(document.surveyForm.answer1.value == '') {
			...
			document.surveyForm.action = "<c:url value='/contents/exercise/insertSurveyResult.do'/>";
	...
	function goUpdateContents() {
		document.listForm.action = "<c:url value='/contents/exerciseEdit.do'/>";
		document.listForm.submit();
	}
	...
	function fnDeleteContents() {
		...
		if (delConfirm) {
			document.listForm.action = "<c:url value='/contents/exerciseDelete.do'/>";
			document.listForm.submit();
		}
	}
...
<section id="FR071101-10" class="content-section">
...
<div class="layerPop-wrap" id="FR071101-15" data-pop-action="disabled">
...
<div class="layerPop-wrap" id="FR071101-20" data-pop-action="disabled">
