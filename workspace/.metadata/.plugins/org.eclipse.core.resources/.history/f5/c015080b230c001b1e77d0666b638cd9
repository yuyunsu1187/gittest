...
<section id="FR050101-10" class="content-section">
	...
	<!-- [2020-08-28] data-board-header="download" data- 속성값 추가 -->
		...
		<input type="hidden" name="uploadFilePath" value="<c:out value='${result.filePath}'/>" />
			...
			<article class="board-content">
				<embed src="<c:url value='${result.filePath}'/>#toolbar=0&pagemode=bookmarks&view=FitH" type="application/pdf" class="embed-area" />
			</article>
			
			<div class="submit-area">
				<button type="button" class="main-btn" onclick="goBack();">Go Back</button>
			</div>
		</form:form>
	</article>
	<!-- [E] 게시물 보기 -->
