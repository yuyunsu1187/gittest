...
//<![CDATA[
	...
	function fnUpdateUserType() {
		...
		document.searchForm.action = "<c:url value='/admin/user/manager/updateUserType.do'/>";
		document.searchForm.submit();
	}
	...
	function fnDeleteUserList() {
		...
		document.searchForm.userCheckList.value = userCheckArr;
		document.searchForm.action = "<c:url value='/admin/user/manager/deleteUserList.do'/>";
		document.searchForm.submit();
		}
	}
...
<section class="content-section">
	...
	<Tag:pagingOut value="showJavaScript" />
		...
		<div class="form-wrap" data-board-type="inquiry">
			...
			<form commandName="result" name="searchForm" id="searchForm" method="post" onsubmit="goPage(1);return false;">
