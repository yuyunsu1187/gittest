...
<script type="text/javascript" language="javascript">
	...
	function goUpdateContents() {
		document.detailForm.action = "<c:url value='/contents/imageryEdit.do'/>";
		document.detailForm.submit();
	}
	
	// 글 작성 화면으로 이동
	function goContentsWrite() {
		document.listForm.action = "<c:url value='/contents/imageryWrite.do'/>";
		document.listForm.submit();
	}
	...
	function fnDeleteContents() {
		...
		if (delConfirm) {
			document.detailForm.action = "<c:url value='/contents/imageryDelete.do'/>";
			document.detailForm.submit();
		}
	}
...
<section id="FR030105-05" class="content-section">
	...
	<c:if test="${menuType=='FR'}">
		<div class="breadcrumb">
			<span class="home">home</span><span class="depth">Branding Platform</span><span class="page">Imagery</span>
		</div>
	</c:if>
	...
	<div class="tab-wrap" data-type="tab" data-tab-division="link">
		...
		<div class="form" data-mult-form="select-list" data-tab-area="tab-list">
			<button type="button" class="select-btn">Imagery<i class="fas fa-angle-down"></i></button>
		...
		<article class="list-wrap" data-list-type="thumbnail" data-combine-list="column-2-list">	
			<form:form commandName="resultList" name="listForm" id="listForm" method="post" >
				...
				<header class="list-header">
					<h3 class="article-tit">Imagery</h3>
					<p class="article-txt">Here you will find images related with LG aesthetics products</p>
					<ul class="sort-list">
						...
						<div class="img-area">
							...
							<div class="caption">
								...
								<div class="data">
									...
									<a href="#" class="download-main-btn" onclick="fnDownload(<c:out value='${index}'/>);">DOWNLOAD<i class="fas fa-arrow-down"></i></a>
								</div>
							</div>
						</div>
					</li>
	...
	<c:if test="${empty resultList}">
		<!-- [S : 20200923] no contents 영역 추가  -->
		<div class="noContents-area">No contents</div>
		<!-- [E : 20200923] no contents 영역 추가  -->
	</c:if>
</section>
