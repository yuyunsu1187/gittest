					...
					<table class="default-table">
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="form" data-mult-form="input-btn"><input type="text" name="email" id="email" class="input-form" value="<c:out value='${result.email}'/>" disabled /></div>
								</td>
							</tr>
							...
							<tr>
								...
								<td><div class="form"><input type="text" name="countryCode" id="countryCode" class="input-form" placeholder="Country" value="<c:out value='${result.countryName}'/>" disabled /></div></td>
							</tr>
							
							<tr data-row-key="doctor">
								<th scale="col">Specialty</th>
								<td><div class="form"><input type="text" name="specialCode" id="specialCode" class="input-form" placeholder="Specialty" value="<c:out value='${result.specialName}'/>" disabled /></div></td>
							</tr>
							
							<tr>
								<th scale="col">Partner name</th>
								<td><div class="form"><input type="text" name="partnerName" id="partnerName" class="input-form" placeholder="Enter Partner name" value="<c:out value='${result.hpName}'/>" disabled /></div></td>
							</tr>
						</tbody>
					</table>
				</div>
						...
						<table class="default-table">
							...
							<tbody>
								<tr>
									...
									<td><div class="form"><input type="text" name="hpName" id="hpName" class="input-form" placeholder="Enter your clinic name" value="<c:out value='${result.hpName}'/>" /></div></td>
								</tr>
								
								<tr>
									<th scale="col">Clinic Address</th>
									<td><div class="form"><input type="text" name="hpAdd" id="hpAdd" class="input-form" placeholder="Enter your clinic address" value="<c:out value='${result.hpAdd}'/>" /></div></td>
								</tr>
								
								<tr>
									<th scale="col">Clinic Postcode / Zip</th>
									<td><div class="form"><input type="text" name="hpZipcode" id="hpZipcode" class="input-form" placeholder="Enter your clinic postcode" value="<c:out value='${result.hpZipcode}'/>" /></div></td>
								</tr>
							</tbody>
						</table>
					</div>
