			...
			<form method="post" action="/common/login/resetPwdUser.do" name="userInfo" onsubmit="return checkValue()">
				<div class="form-wrap">
					...
					<div class="submit-area">
						<button type="button" class="sub-btn" data-offset="left" onclick="goLoginForm()">Back to login</button>
						<button type="submit" class="main-btn" data-offset="right">Resend email</button>
					</div>	
				</div>
			</form>
		</section>
