...
<script type="text/javascript" language="javascript">
	...
	function goContentsDetail(num) {
		document.listForm.seq.value = num;
	   	document.listForm.action = "<c:url value='/contents/partnerDetail.do'/>";
	   	document.listForm.submit();
	}
	
	// 글 작성 화면으로 이동
	function goContentsWrite() {
		document.listForm.action = "<c:url value='/contents/partnerWrite.do'/>";
		document.listForm.submit();
	}

	function goUpdateContents() {
		document.detailForm.action = "<c:url value='/contents/partnerEdit.do'/>";
		document.detailForm.submit();
	}
	...
	function fnDeleteContents() {
		...
		if (delConfirm) {
			document.detailForm.action = "<c:url value='/contents/partnerDelete.do'/>";
			document.detailForm.submit();
		}
	}
...
<section id="FR050107-05" class="content-section">
	<header class="content-header">
		<h2 class="content-tit">For Partner</h2>
	</header>
	
	<div class="breadcrumb">
		<span class="home">home</span><span class="depth">Medical Platform</span><span class="page">For Partner</span>
	</div>
