package devonframe.gyva.admin.contents.clinic.controller;
...
@Controller
public class AdminClinicContentsController {
    ...
    @RequestMapping(value="/admin/contents/clinic/retrieveContentsList.do")
    public String retrieveContentsList(Contents input, ModelMap model){
        ...
        return "admin/contents/library/clinic/contentsList";
    }
    
    @RequestMapping(value="/admin/contents/clinic/retrieveContents.do")
    public String retrieveContentsDetail(Contents input, ModelMap model){
        ...
        return "admin/contents/library/clinic/contentsDetail";
    }
...
//		String nextContentsId =  contentsService.retrieveNextContentsId(input);
		String nextContentsId =  contentsService.retrieveFunNextContentsId("clinic_id");
	...
	@RequestMapping(value = "/admin/contents/library/clinic/updateContentsPage.do")
	public String contentsUpdate(Contents input, Code code, ModelMap model, HttpSession session) {
		...
		return "admin/contents/library/clinic/contentsUpdate";
	}
	
	// Contents 저장
	@RequestMapping(value = "/admin/contents/clinic/insertContents.do")
	public String insertContents(Contents input, ModelMap model, MultipartHttpServletRequest mpRequest, HttpSession session) {
		...
		String menuId = (String) session.getAttribute("MenuInfoInterceptor_menuId");
		String redirectUrl = "redirect:/contents/clinic/retrieveContentsList.do?menuId=" + menuId;
		
		return redirectUrl;
	}

	// Contents 수정 처리
	@RequestMapping(value = "/admin/contents/library/clinic/updateContents.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/admin/contents/library/clinic/deleteContents.do")
