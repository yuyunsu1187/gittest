...
public class AdminAnatomyContentsController {
	...
	public String retrieveContentsList(HttpServletRequest request, Contents input, ModelMap model, HttpSession session) {
		...
		//request.setAttribute("menuId", (String) session.getAttribute("MenuInfoInterceptor_menuId"));
		System.out.println("===================== after work request menuId : " + (String) request.getAttribute("menuId"));
	...
	@ResponseBody
	@RequestMapping(value = "/admin/contents/anatomy/updateLikeDislike.do")
	...
	// 관리자 Contents 수정 페이지
	@RequestMapping(value = "/admin/contents/academy/anatomy/contentsUpdate.do")
	...
	// Contents 저장
	@RequestMapping(value = "/admin/contents/academy/anatomy/insertContents.do")
	public String insertContents(Contents input, Code code, ModelMap model, MultipartHttpServletRequest mpRequest,
		...
		System.out.println("===================== session menuId : " + (String) session.getAttribute("MenuInfoInterceptor_menuId"));
		String redirectUrl = "redirect:/admin/contents/anatomy/retrieveContentsList.do?menuId=" + menuId;
		
		return redirectUrl;
	}

	// Contents 수정
	@RequestMapping(value = "/admin/contents/academy/anatomy/updateContents.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/admin/contents/academy/anatomy/deleteContents.do")
