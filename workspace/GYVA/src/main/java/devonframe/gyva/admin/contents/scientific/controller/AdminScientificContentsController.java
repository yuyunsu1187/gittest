package devonframe.gyva.admin.contents.scientific.controller;
...
@Controller
public class AdminScientificContentsController {
    ...
    @RequestMapping(value="/admin/contents/scientific/retrieveContentsList.do")
    public String retrieveContentsList(Contents input, ModelMap model){
        ...
        return "admin/contents/library/scientific/contentsList";
    }
    
    @RequestMapping(value="/admin/contents/scientific/retrieveContents.do")
    public String retrieveContentsDetail(Contents input, ModelMap model){
        ...
        return "admin/contents/library/scientific/contentsDetail";
    }
...
//		String nextContentsId =  contentsService.retrieveNextContentsId(input);
	...
	@RequestMapping(value = "/admin/contents/library/scientific/updateContentsPage.do")
	public String contentsUpdate(Contents input, Code code, ModelMap model, HttpSession session) {
		...
		return "admin/contents/library/scientific/contentsUpdate";
	}
	
	// Contents 저장
	@RequestMapping(value = "/admin/contents/scientific/insertContents.do")
...
int i=0;
		while (iterator.hasNext()) {
			...
			if (multipartFile.isEmpty() == false) {
				...
				System.out.println("\t\t uploadFileInfo:i"+i+"/"+uploadFileInfo.getClientFileName());
				i++;
		...
		String menuId = (String) session.getAttribute("MenuInfoInterceptor_menuId");
		String redirectUrl = "redirect:/contents/scientific/retrieveContentsList.do?menuId=" + menuId;
		
		return redirectUrl;
	}

	// Contents 수정 처리
	@RequestMapping(value = "/admin/contents/library/scientific/updateContents.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/admin/contents/library/scientific/deleteContents.do")
