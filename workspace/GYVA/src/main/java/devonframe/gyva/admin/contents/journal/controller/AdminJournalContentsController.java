package devonframe.gyva.admin.contents.journal.controller;
...
@Controller
public class AdminJournalContentsController {
    ...
    @RequestMapping(value="/admin/contents/journal/retrieveContentsList.do")
    public String retrieveContentsList(Contents input, ModelMap model){
        ...
        return "admin/contents/library/journal/contentsList";
    }
    
    @RequestMapping(value="/admin/contents/journal/retrieveContents.do")
    public String retrieveContentsDetail(Contents input, ModelMap model){
        ...
        return "admin/contents/library/journal/contentsDetail";
    }
		
	// 관리자 Contents 입력 페이지
	@RequestMapping(value = "/admin/contents/library/journal/contentsWrite.do")
...
//		String nextContentsId =  contentsService.retrieveNextContentsId(input);
		String nextContentsId =  contentsService.retrieveFunNextContentsId("journal_id");
		
		model.addAttribute("resultList", resultList);
		model.addAttribute("menuId", menuId);
		model.addAttribute("nextContentsId", nextContentsId);
		return "admin/contents/library/journal/contentsWrite";
	}
	
	// 관리자 Contents 수정 페이지 호출
	@RequestMapping(value = "/admin/contents/library/journal/updateContentsPage.do") 
	public String contentsUpdate(Contents input, Code code, ModelMap model, HttpSession session) {
		...
		return "admin/contents/library/journal/contentsUpdate";
	}
	
	
	// Contents 저장
	@RequestMapping(value = "/admin/contents/journal/insertContents.do")
	public String insertContents(Contents input, ModelMap model, MultipartHttpServletRequest mpRequest, HttpSession session) {
		...
		String menuId = (String) session.getAttribute("MenuInfoInterceptor_menuId");
		String redirectUrl = "redirect:/contents/journal/retrieveContentsList.do?menuId=" + menuId;
	...
	// Contents 수정 처리
	@RequestMapping(value = "/admin/contents/library/journal/updateContents.do")
	...
	// Contents 삭제
	@RequestMapping(value = "/admin/contents/library/journal/deleteContents.do")
