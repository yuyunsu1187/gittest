package devonframe.gyva.front.contents.event.controller;
...
public class EventContentsController {
    ...
    @RequestMapping(value="/contents/event/retrieveContentsList.do")
    public String retrieveContentsList(Contents input, ModelMap model){
        ...
        return "contents/news/event/contentsList";
    }
    
    @RequestMapping(value="/contents/event/retrieveContents.do")
    public String retrieveContentsDetail(Contents input, ModelMap model){
        ...
        return "contents/news/event/contentsDetail";
    }
