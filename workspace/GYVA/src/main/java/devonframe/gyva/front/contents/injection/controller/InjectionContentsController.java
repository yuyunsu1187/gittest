package devonframe.gyva.front.contents.injection.controller;
...
public class InjectionContentsController {
    ...
    @RequestMapping(value="/contents/injection/retrieveContentsList.do")
...
//		input.setMenuId(menuId);
        ...
        return "contents/academy/injection/contentsList";
    }
    
    @RequestMapping(value="/contents/injection/retrieveContents.do")
    ...
    @ResponseBody
	@RequestMapping(value = "/contents/injection/updateLikeDislike.do")
