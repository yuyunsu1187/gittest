package devonframe.gyva.front.contents.branding.controller;
...
@Controller
public class BrandingContentsController {

    @Resource(name = "contentsService")
    private ContentsService contentsService;
    
    @RequestMapping(value="/contents/branding/retrieveContentsList.do")
    public String retrieveContentsList(Contents input, ModelMap model){
        ...
        return "contents/branding/contentsList";
    }
    
    @RequestMapping(value="/contents/branding/retrieveContents.do")
    public String retrieveContentsDetail(Contents input, ModelMap model){
        ...
        return "contents/branding/contentsDetail";
    }
