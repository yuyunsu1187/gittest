...
public class InquiryController {
    ...
    @RequestMapping(value="/mypage/inquiry/retrieveContentsList.do")
    public String retrieveContentsList(Contents input, ModelMap model){
        ...
        return "mypage/inquiry/contentsList";
    }
    
    @RequestMapping(value="/mypage/inquiry/retrieveContents.do")
    public String retrieveContentsDetail(Contents input, ModelMap model){
        ...
        return "mypage/inquiry/contentsDetail";
    }
