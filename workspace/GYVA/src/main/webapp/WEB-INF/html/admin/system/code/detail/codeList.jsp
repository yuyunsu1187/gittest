...
<title><spring:message code="gyva.common.code.codeManagement"/></title>
...
<body id="LblockBody" onload="checkMessage()">
	...
	<div id="LblockPageHeader">
		<div id="LblockPageTitle">
			<h1><spring:message code="gyva.common.code.codeManagement"/></h1>
		</div>
	</div>
	...
	<form:form commandName="input" name="pForm" method="post" onsubmit="fncRetrieveCodeList()">
		...
		<div id="LblockBodyMain">
			<div id="LblockSearch">
				...
				<div>
				<div>
					<table summary="<spring:message code="gyva.common.code.codeSearch"/>">
						<caption><spring:message code="gyva.common.code.codeSearch"/></caption>
						<tbody>
							<tr>
								<th width="8%"><label for=codeGroup><spring:message code="gyva.common.code.codeGroup"/></label></th>
								<td>
			...
			<div id="LblockPageSubtitle2" class="LblockPageSubtitle">
				<h2><spring:message code="gyva.common.code.codeList"/></h2>
			</div>
			<div id="LblockListTable01" class="LblockListTable">
				<div class="Lwrapper">
					<table summary="<spring:message code="gyva.common.code.codeList"/>">
						<caption><spring:message code="gyva.common.code.codeList"/></caption>
						<thead>
							<tr>
								<th><spring:message code="gyva.common.code"/></th>
								<th><spring:message code="gyva.common.code.codeGroup"/></th>
								<th><spring:message code="gyva.common.code.codeName"/></th>
								<th class="Llast"><spring:message code="gyva.common.code.codeDesc"/></th>
							</tr>
						</thead>
						<tbody>
