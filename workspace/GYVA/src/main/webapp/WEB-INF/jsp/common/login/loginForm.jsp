		...
		<div id="LblockLogin" class="LblockLogin">
			...
			<div class="body">
				<fieldset>
					...
					<p class="btn"><input type="image" src="<c:url value="/resource/images/login_btn.gif" />" onclick="fnLogin()" /></p>				
				</fieldset>
			</div>
			<ul class="menu">
				<li class="Lfirst"><a href="<c:url value="/common/login/joinForm.do"/>">Join Us</a></li>
				<li class="Lidx1"><a href="<c:url value="/common/login/resetPassword.do"/>">P/W Reset</a></li>
				<li class="Llast"><a href="<c:url value="/main.do?menu1=1&admin=Y"/>">Admin</a></li>
			</ul>
		</div>
	</form>
