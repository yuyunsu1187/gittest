...
//<![CDATA[
	...
	function fnDeleteContents() {
		document.contentsInfo.action = "<c:url value='/admin/contents/library/partner/deleteContents.do'/>";
...
<section class="content-section">
	...
	<article class="board-wrap" data-board-type="form-write">
		<div class="board-area">
			...
			<form method="post" action="/admin/contents/library/partner/updateContents.do" name="contentsInfo" id="contentsInfo" onsubmit="return checkValue()" enctype="multipart/form-data">
