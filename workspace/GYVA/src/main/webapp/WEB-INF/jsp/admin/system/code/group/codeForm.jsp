...
<body id="LblockBody">
	...
	<div id="LblockPageSubtitle" class="LblockPageSubtitle">
		<h2><spring:message code="gyva.common.code.codeDetail"/></h2>
	</div>
	...
	<form:form commandName="codeVO" name="pForm" method="post">
		...
		<div id="LblockBodyMain">
			<div id="LblockDetail" class="LblockDetail">
				<table summary="<spring:message code="gyva.common.code.codeDetail"/>">
					<caption><spring:message code="gyva.common.code.codeDetail"/></caption>
					<tbody>
						<tr>
						...
						<tr>
							...
							<th><spring:message code="gyva.common.code.codeDesc"/></th>
