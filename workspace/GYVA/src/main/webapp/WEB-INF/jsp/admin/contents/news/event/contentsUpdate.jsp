			...
			<table class="default-table">
				...
				<tbody>							
					...
					<tr>
						...
						<td><div class="form"><input type="text" class="input-form" placeholder="제목을 입력해주세요." value="http://www.lgyvoire.com/" /></div></td>
					</tr>
					...
					<tr>
						...
						<td><div class="form"><input type="text" class="input-form" placeholder="강연자을 입력해주세요." value="Dr. Fundaro" /></div></td>
					</tr>
					
					<tr>
						<th scale="col" data-text-style="essential">장소</th>
						<td><div class="form"><input type="text" class="input-form" placeholder="장소를 입력해주세요." value="Paris Congress" /></div></td>
					</tr>
					
					<tr>
						<th scale="col">비고</th>
						<td><div class="form"><input type="text" class="input-form" placeholder="비고를 입력해주세요." value="" /></div></td>
					</tr>
				</tbody>
			</table>
		</div>
