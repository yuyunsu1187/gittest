			...
			<table class="default-table">
				...
				<tbody>
					...
					<tr>
						...
						<td><div class="form"><textarea class="input-form" placeholder="문의 내용을 입력해주세요." rows="12"></textarea></div></td>
					</tr>
					...
					<tr>
						<th scale="col">비고</th>
						<td><div class="form"><textarea class="input-form" placeholder="비고 내용을 입력해주세요." rows="12"></textarea></div></td>
					</tr>
				</tbody>
			</table>
		</div>
