...
//<![CDATA[	
	...
	// 파일 저장
	function fnSave() {
		document.contentsInfo.action = "<c:url value='/admin/contents/partner/insertContents.do'/>";
...
<section class="content-section">
	...
	<article class="board-wrap" data-board-type="form-write">
		<div class="board-area">
			...
			<form method="post" action="/admin/contents/partner/insertContents.do" name="contentsInfo" id="contentsInfo" onsubmit="return checkValue()" enctype="multipart/form-data">				
				...
				<table class="default-table">
					<caption>For Partner 입력</caption>
					<colgroup>
						<col style="width:30%;" />
