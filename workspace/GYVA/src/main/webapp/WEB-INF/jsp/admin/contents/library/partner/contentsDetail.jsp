...
<script type="text/javaScript" language="javascript">
	...
	function fnRetrieveList() {
		document.detailForm.action = "<c:url value='/contents/partner/retrieveContentsList.do'/>";
	...
	function goUpdateContents() {
		document.detailForm.action = "<c:url value='/admin/contents/library/partner/updateContentsPage.do'/>";
		document.detailForm.submit();
	}
	
	function fnDeleteContents() {
		document.detailForm.action = "<c:url value='/admin/contents/library/partner/deleteContents.do'/>";
		document.detailForm.submit();
	}
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		<div id="LblockPageTitle">
			<h1>Distributor Material</h1>
		</div>

		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>Admin Distributor Material Detail</span></li>
			</ul>
		</div>
	</div>
		...
		<div id="LblockListTable01" class="LblockListTable" >
			...
			<div class="Lwrapper">
				...
				<input type="hidden" name="uploadFilePath" value="${result.filePath}" />
					<table summary="Distributor Material Detail" style="font:100%/1.5em Gulim;">
