...
<script type="text/javaScript" language="javascript">
	...
	function fnRetrieveList() {
		document.detailForm.action = "<c:url value='/contents/scientific/retrieveContentsList.do'/>";
	...
	function goUpdateContents() {
		document.detailForm.action = "<c:url value='/admin/contents/library/scientific/updateContentsPage.do'/>";
		document.detailForm.submit();
	}
	
	function fnDeleteContents() {
		document.detailForm.action = "<c:url value='/admin/contents/library/scientific/deleteContents.do'/>";
		document.detailForm.submit();
	}
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		<div id="LblockPageTitle">
			<h1>scientific Material</h1>
		</div>

		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>Admin scientific Material Detail</span></li>
			</ul>
		</div>
	</div>
		...
		<div id="LblockListTable01" class="LblockListTable" >
			...
			<div class="Lwrapper">
				...
				<input type="hidden" name="uploadFilePath" value="${result.filePath}" />
					<table summary="scientific Material Detail" style="font:100%/1.5em Gulim;">
						<caption>scientific Material </caption>
						<thead>
							<tr>
