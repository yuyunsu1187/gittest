...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/admin/contents/webinar/retrieveContentsList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/admin/contents/webinar/retrieveContents.do'/>";
   	document.searchForm.submit();
}
//]]>
</script>
