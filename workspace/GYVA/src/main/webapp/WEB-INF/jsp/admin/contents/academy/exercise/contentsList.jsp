...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/admin/contents/exclusive/retrieveContentsList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/admin/contents/exclusive/retrieveContents.do'/>";
   	document.searchForm.submit();
}
//]]>
</script>
...
<section class="content-section">
	<header class="content-header">
		<h2 class="content-tit">YVOIRE Exclusive</h2>
	</header>
