...
//<![CDATA[	
	...
	// 파일 저장
	function fnSave() {
		document.contentsInfo.action = "<c:url value='/admin/contents/journal/insertContents.do'/>";
...
<section class="content-section">
	...
	<article class="board-wrap" data-board-type="form-write">
		...
		<form method="post" action="/admin/contents/journal/insertContents.do" name="contentsInfo" id="contentsInfo" onsubmit="return checkValue()" enctype="multipart/form-data">
