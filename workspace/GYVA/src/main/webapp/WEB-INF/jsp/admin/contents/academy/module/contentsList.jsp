...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/admin/contents/module/retrieveContentsList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/admin/contents/module/retrieveContents.do'/>";
   	document.searchForm.submit();
}
//]]>
</script>
...
<section class="content-section">
	<header class="content-header">
		<h2 class="content-tit">Module</h2>
	</header>
	
	<article class="board-wrap" data-board-type="form-list">
		<div class="board-area">
		
			<table summary="Module" style="font:100%/1.5em Gulim;">
