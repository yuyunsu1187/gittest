...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/mypage/inquiry/retrieveContentsList.do'/>";
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		...
		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>1:1 Content</span></li>
			</ul>
		</div>
	</div>
	...
	<div id="LblockBodyMain">
		...
		<div id="LblockListTable01" class="LblockListTable" >
			...
			<div class="Lwrapper">
				<table summary="1:1 Content" style="font:100%/1.5em Gulim;">
					<caption>1:1 Content</caption>
					<thead>
						<tr>
