...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/contents/event/retrieveContentsList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/contents/event/retrieveContents.do'/>";
   	document.searchForm.submit();
}
//]]>
</script>
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		...
		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>EVENT</span></li>
			</ul>
		</div>
	</div>
	...
	<div id="LblockBodyMain">
		...
		<div id="LblockListTable01" class="LblockListTable" >
			...
			<div class="Lwrapper">
				<table summary="Webinar" style="font:100%/1.5em Gulim;">
