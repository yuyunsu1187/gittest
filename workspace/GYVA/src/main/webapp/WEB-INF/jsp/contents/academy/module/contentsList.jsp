...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/contents/module/retrieveContentsList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/contents/module/retrieveContents.do'/>";
   	document.searchForm.submit();
}
//]]>
</script>
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		...
		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>Module</span></li>
			</ul>
		</div>
	</div>
