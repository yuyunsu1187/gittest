...
function fnDetail(listForm, seq, contentsId, categoryCode) {
	...
	listForm.action = "<c:url value='/contents/anatomy/retrieveContents.do'/>";
	listForm.submit();
...
function fnlikeDislike(listForm, seq, contentsId) {
	...
	$.ajax({
		url : "/contents/anatomy/updateLikeDislike.do",
		type : "post",
		dataType : "json",
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		...
		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>Anatomy</span></li>
			</ul>
		</div>
	</div>
	...
	<div id="LblockBodyMain">
		<div id="LblockListTable01" class="LblockListTable" >
			...
			<input type="hidden" name="contentsId" id="contentsId" value="" />
				...
				<table summary="Anatomy Upper" style="font:100%/1.5em Gulim;">
					<caption>Anatomy Upper</caption>
					<thead>
						<tr>
							<!-- 
			...
			<input type="hidden" name="contentsId" id="contentsId" value="" />
				...
				<table summary="Anatomy Mid" style="font:100%/1.5em Gulim;">
					<caption>Anatomy Mid</caption>
					<thead>
						<tr>
							<th class="Lfirst">썸네일 이미지</th>
							<th>파일 경로</th>
			...
			<input type="hidden" name="contentsId" id="contentsId" value="" />
				...
				<table summary="Anatomy Low" style="font:100%/1.5em Gulim;">
					<caption>Anatomy Low</caption>
					<thead>
						<tr>
							<th class="Lfirst">썸네일 이미지</th>
							<th>파일 경로</th>
