...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/contents/exclusive/retrieveContentsList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/contents/exclusive/retrieveContents.do'/>";
   	document.searchForm.submit();
}
//]]>
</script>
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		<div id="LblockPageTitle">
			<h1>YVOIRE Exclusive</h1>
		</div>

		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>YVOIRE Exclusive</span></li>
			</ul>
		</div>
	</div>
	...
	<div id="LblockBodyMain">
		...
		<div id="LblockListTable01" class="LblockListTable" >
			...
			<div class="Lwrapper">
				<table summary="YVOIRE Exclusive" style="font:100%/1.5em Gulim;">
					<caption>YVOIRE Exclusive</caption>
					<thead>
						<tr>
