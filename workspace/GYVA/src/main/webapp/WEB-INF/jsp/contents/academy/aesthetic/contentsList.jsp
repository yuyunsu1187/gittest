...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/contents/esthetic/retrieveContentsList.do'/>";
	document.searchForm.submit();
}
function fnDetail(num) {
	document.searchForm.num.value = num;
   	document.searchForm.action = "<c:url value='/contents/esthetic/retrieveContents.do'/>";
   	document.searchForm.submit();
}
//]]>
</script>
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		<div id="LblockPageTitle">
			<h1>Aesthetic School</h1>
		</div>

		<div id="LblockPageLocation">
			<ul>
				<li class="Llast"><span>Aesthetic School</span></li>
			</ul>
		</div>
	</div>
