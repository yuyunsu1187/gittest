...
function fnRetrieveList() {
	document.searchForm.action = "<c:url value='/contents/injection/retrieveContentsList.do'/>";
...
function goInjectionContentsList() {
	listForm.action = "<c:url value='/contents/injection/retrieveContentsList.do'/>";
	listForm.submit();
}
